...
import type { IBinaryData, IDataObject, IExecuteFunctions, INodeExecutionData } from 'glow-workflow';
import { NodeOperationError, BINARY_ENCODING } from 'glow-workflow';
