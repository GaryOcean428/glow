...
import AssistantIcon from '@glow/design-system/components/AskAssistantIcon/AssistantIcon.vue';
import AssistantText from '@glow/design-system/components/AskAssistantText/AssistantText.vue';
