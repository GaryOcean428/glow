...
import type { ElementPlusSizePropType, InputAutocompletePropType } from '@glow/design-system/types';
import type { InputSize, InputType } from '@glow/design-system/types/input';
