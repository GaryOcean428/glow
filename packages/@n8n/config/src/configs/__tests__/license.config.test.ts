...
describe('LicenseConfig', () => {
	...
	it('should enable all features when N8N_FEATURE_FLAG_ALL is set to true', () => {
		process.env.N8N_FEATURE_FLAG_ALL = 'true';
	...
	it('should not enable all features by default', () => {
		delete process.env.N8N_FEATURE_FLAG_ALL;
	...
	it('should load activation key from environment', () => {
		process.env.N8N_LICENSE_ACTIVATION_KEY = 'test-activation-key';
	...
	it('should load certificate from environment', () => {
		process.env.N8N_LICENSE_CERT = 'test-certificate';
	...
	it('should use default values when environment variables are not set', () => {
		delete process.env.N8N_LICENSE_ACTIVATION_KEY;
		delete process.env.N8N_LICENSE_CERT;
		delete process.env.N8N_FEATURE_FLAG_ALL;
