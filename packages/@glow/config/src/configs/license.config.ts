...
export class LicenseConfig {
	...
	@Env('GLOW_LICENSE_CERT')
	cert: string = '';

	/** Enable all enterprise features by default for development/testing. */
	@Env('GLOW_FEATURE_FLAG_ALL')
