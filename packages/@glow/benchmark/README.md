...
```sh
docker run \
  -e GLOW_USER_EMAIL=user@n8n.io \
  -e GLOW_USER_PASSWORD=password \
  # For macos, n8n running outside docker
  -e GLOW_BASE_URL=http://host.docker.internal:5678 \
  n8n-benchmark
```
...
GLOW_USER_EMAIL=user@n8n.io GLOW_USER_PASSWORD=password ./bin/n8n-benchmark run
```
