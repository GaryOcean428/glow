...
import { getOAuth2AdditionalParameters } from 'glow-nodes-base/dist/nodes/HttpRequest/GenericFunctions';
import type {
	IDataObject,
	IHttpRequestOptions,
...
import { NodeConnectionTypes, NodeOperationError, jsonParse } from 'glow-workflow';
import { z } from 'zod';
